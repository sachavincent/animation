...
const std::string Shader::SHADER_PATH = "../../../../assets/shaders/";
...
void Shader::loadMatrix4(const std::string& name, glm::mat4 value, int nb) const
{
    glUniformMatrix4fv(glGetUniformLocation(this->ID, name.c_str()), nb, GL_FALSE, (GLfloat*) &value);
}
